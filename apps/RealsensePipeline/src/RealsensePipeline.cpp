...
int main(int argc, char* argv[])
{
    ...
    cxxopts::Options options("realsense pipeline",
                             "offline realsense pipeline");
    ...
    cv::Mat color0 =
        cv::imread("/home/asharma/realsense-rgbd-slam/Data/1_color.png");
    cv::Mat color1 =
        cv::imread("/home/asharma/realsense-rgbd-slam/Data/2_color.png");

    cv::Mat depth0 =
        cv::imread("/home/asharma/realsense-rgbd-slam/Data/1_depth.png",
                   cv::IMREAD_ANYDEPTH);
    cv::Mat depth1 =
        cv::imread("/home/asharma/realsense-rgbd-slam/Data/2_depth.png",
                   cv::IMREAD_ANYDEPTH);
